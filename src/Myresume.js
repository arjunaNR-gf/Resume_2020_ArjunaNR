...
useEffect(()=>
{
 ...
 window.addEventListener('resize',setperosonaldetails);
  ...
  return (
    ...
    <div className={display ? "mobile":"website"}>
      ...
      <div className={windowsidebar?"Side-bar-mobile":"Side-bar"}>
            ...
            <div style={{marginLeft:"7px",display:"flex"}}><CastForEducationIcon/></div> <p>MYRESUME</p>
            </div>
    ...
    <div className="my-clg-exy">
        <p className="p2" style={{width:"30%",padding:"0.1%",marginTop:"1%",backgroundColor:"#40ccc5"}}>EXPERIENCE</p>
       ...
       <div style={{display:"flex",marginLeft:"1%"}}> <p style={{textDecorationLine:'underline',textDecorationColor:"lavender"}}>OtherExperience:</p><p> 
           <div style={{width:"94%",height:"auto",padding:"2%",backgroundColor:"white",border:"2px solid lavender"}}> My name is Arjuna N R , I completed my post graduation in MCA at JNNCE shivamogga,
    ...
    <div className="my-clg-exy"><p className="p2" style={{width:"30%",padding:"0.1%",marginTop:"1%",backgroundColor:"#40ccc5"}}>EDUCATION</p>
    ...
    <div className="my-clg-exy"><p className="p2"  style={{width:"32%",height:"auto",padding:"0.1%",marginTop:"1%",backgroundColor:"#40ccc5"}}>PROGRAMING LANGUAGE KNOWS</p>
  ...
  <div style={{width:"90%",height:"auto",backgroundColor:"white",border:"1px solid lavender",marginLeft:"1%",padding:"1%"}}>
    <div style={{marginLeft:"35%"}}> <tr>  Technology : PHP , HTML , CSS , JAVASCRIPT   </tr>
     ...
     <p></p>
     <p></p>
     <div style={{display:"flex",marginLeft:"1%",textDecorationLine:"underline",textDecorationColor:"lavender",marginTop:"1%"}}><p>2.RTO MANAGEMENT</p><p> : </p>
     </div> 
 <div style={{width:"90%",height:"auto",backgroundColor:"white",border:"1px solid lavender",marginLeft:"1%"}}>
     <tr>Technology : PHP , HTML , CSS , JAVASCRIPT(mini project)</tr> 
     <tr>Descreption : This is a software we can take online exam</tr>       
       
        </div>
     <div style={{display:"flex",marginLeft:"1%" ,textDecorationLine:"underline",textDecorationColor:"lavender",marginTop:"1%"}}><p>3.PARKING LOT(mini project)</p><p> : </p>
     </div> 
     <div style={{width:"90%",height:"auto",backgroundColor:"white",border:"1px solid lavender",marginLeft:"2%"}}>
    ...
    <div className="my-clg-exy">
     ...
     <table>
     <div style={{width:"90%",height:"auto",backgroundColor:"white",border:"1px solid lavender",marginLeft:"5%",marginTop:"3%",marginBottom:"2%",padding:"1%"}}>  <tr><td>ReadingBooks, </td><td>Playing and Watching Crecket,  </td><td>Listening Music</td></tr></div>
     </table>
    </div>  
